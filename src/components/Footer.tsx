      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-2xl font-bold mb-4">Yellow Mountain</h2>
            <p className="text-gray-300 mb-4">
              Comprehensive investment solutions for individuals, families, and businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="text-gray-300 hover:text-white">Investment Planning</Link></li>
              <li><Link to="/" className="text-gray-300 hover:text-white">Wealth Management</Link></li>
              <li><Link to="/" className="text-gray-300 hover:text-white">Retirement Planning</Link></li>
              <li><Link to="/" className="text-gray-300 hover:text-white">Estate Planning</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/" className="text-gray-300 hover:text-white">Disclosures</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-sm text-gray-400 text-center">© 2024 Yellow Mountain Capital. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
