  ...
  const renderIcon = (iconName) => {
    return (
      <div className="h-6 w-6 text-primary">
        {iconName === "BarChart3" && <span className="block h-6 w-6 bg-primary/20 rounded-full"></span>}
        {iconName === "Server" && <span className="block h-6 w-6 bg-primary/20 rounded-full"></span>}
        {iconName === "Package" && <span className="block h-6 w-6 bg-primary/20 rounded-full"></span>}
      </div>
    );
  };
